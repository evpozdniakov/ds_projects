...
## <a name="dataset"></a>Знакомство с датасетом
...
## <a name="first-view"></a>Предварительный анализ данных
...
## <a name="global-view"></a>Глобальный анализ показателей
...
## <a name="candidates"></a>Анализ кандидатов для заказчиков
