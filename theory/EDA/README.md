...
Показывает корреляцию *непрерывных числовых* признаков с *нормальным* распределением. (Если ваши признаки не распределены нормально, то их нужно или нормализовать, или воспользоваться другими методами.)
